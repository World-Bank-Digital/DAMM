...
**1. How many of the 57 rows land on the same level?** **24 of 57** (42%). Of the 25 rows where both assessments set a level at all, 15 agree exactly (60%) and 24 are within one level (96%).
...
**3. Gaps.** The verified assessment records **5** (2.1, 5.12, 6.3, 6.13, 8.17). The shadow run records **20**, of which it found **5** of the recorded ones and raised **15** the verified assessment does not carry. It also set **11** ratification holds against the verified assessment's 5.
...
**5. Cost and time.** **$21.88** across 1651 vendor calls in 38 minutes, against a $500 country ceiling — 4.4% of it, across 2 passes (EGY_shadow, EGY_shadow_g2). By vendor: anthropic $11.57, perplexity $3.70, openai $3.70, exa $1.94, jina $0.97.
...
| 7.12 | Responsible-AI safeguards (consent | Absent | **Unverified** | L1 → no level | Egypt adopted a cross-sector Egyptian Charter for Responsible AI, launched by the National Council for Artifi… |
...
| C2 | 2.88 (Established) | 8/0 | 3.33 (Established) | 3/3 |
| C3 | 3.25 (Established) | 8/0 | 3.4 (Advanced) | 5/1 |
| C4 | 3.33 (Established) | 3/3 | 3.0 (Established) | 3/0 |
| E1 | 3.11 (Established) | 9/0 | 2.33 (Emerging) | 3/5 |
...
- **1 row read higher** than the verified assessment.
...
- **9 rows read lower.** 2.5 (L5→L4), 3.6 (L4→L3), 3.7 (L4→L3), 4.6 (L4→L3), 4.9 (L4→L3), 5.5 (L4→L3), 3.9 (L4→L3), 3.10 (L4→L3), 8.4 (L2→L1)
- **22 rows withheld a level** the verified assessment set: 1.5, 1.6, 1.7, 2.7, 3.3, 3.4, 3.5, 3.8, 3.11, 4.4, 4.5, 4.7, 5.8, 6.4, 6.9, 6.12, 6.14, 7.2, 7.12, 8.9, 8.11, 8.12.
...
| 3.7 | Satellite/EO data integration | Documented L4 | Documented L3 | **differs** | The indicator name, 'Satellite/EO data integration', fixes neither the object (integration into wha… |
...
| 4.9 ⚑ | Inter-ministerial coordination mecha | Documented L4 | Documented L3 | **differs** | An Inter-Ministerial Committee was formed by a decree from the prime minister to follow up the impl… |
...
| 7.2 | AI-enabled agricultural solutions de | Documented L3 | Documented no level | **differs** | The indicator name asserts DEPLOYMENT. The strongest admissible (T1) Egypt-specific evidence descri… |
| 7.12 ⚑ | Responsible-AI safeguards (consent,  | Documented L1 | Documented no level | **differs** | Egypt adopted a cross-sector Egyptian Charter for Responsible AI, launched by the National Council … |
| 8.2 | Account ownership, female (%) | Measured L3 | Measured L3 | match |  |
| 8.4 | Mobile money account (%) | Measured L2 | Measured L1 | **differs** | 0.0 |
...
The number to act on is the **abstention rate**: 11 holds and 20 gaps against the verified 5 and 5. Too loose and everything reads Ready; too tight and everything reads Unverified. These figures are what that threshold should be tuned against, and they should be kept — when automated Gate 2 arrives, re-running this comparison is what tells you whether it earns its 15% of the budget.
